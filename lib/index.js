...
const onTurnErrorHandler = (context, error) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield context.sendActivity('ボット内でエラーまたはバグが発生しました。');
    yield context.sendActivity('ボットを実行するには、ボットのソースコードを修正してください。');
});
...
server.post('/api/messages', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
